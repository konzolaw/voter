...
urlpatterns = [
    ...
    path('candidates/add/', views.CandidateViewSet.as_view({'post': 'add_candidate'}), name='add-candidate'),
    path('candidates/<int:pk>/remove/', views.CandidateViewSet.as_view({'delete': 'remove_candidate'}), name='remove-candidate'),
